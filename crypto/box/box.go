...
func Precompute(peersPublicKey, privateKey []byte) (sharedKey []byte) {
...
func Seal(out, message []byte, nonce [xchacha20poly1305.NonceSize]byte, peersPublicKey, privateKey *[32]byte) []byte {
	sharedKey := Precompute(&sharedKey, peersPublicKey, privateKey)
	xchacha20poly1305.New(sharedKey)
	return xchacha20poly1305.Seal(out, nonce, message, nil)
}

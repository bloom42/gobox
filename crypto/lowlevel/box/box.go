...
// func SealAfterPrecomputation(out, message []byte, nonce [crypto.AEADNonceSize]byte, sharedKey [crypto.AEADKeySize]byte) ([]byte, error) {
// 	cipher, err := crypto.NewAEAD(sharedKey[:])
// 	if err != nil {
// 		return nil, err
// 	}
...
// // shared key as generated by Precompute.
// func OpenAfterPrecomputation(out, ciphertext []byte, nonce [crypto.AEADNonceSize]byte, sharedKey [crypto.AEADKeySize]byte) ([]byte, error) {
// 	cipher, err := crypto.NewAEAD(sharedKey[:])
// 	if err != nil {
// 		return nil, err
// 	}
